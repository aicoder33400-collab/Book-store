...
const GENRES = [
  ...
  { label: '⚖️ Fiqh', value: 'FIQH' },
  { label: '🤲 Aqida', value: 'AQIDA' },
  { label: '🌟 Sira', value: 'SIRA' },
  { label: '📜 Sunna', value: 'SUNNA' },
  { label: '💫 Spiritualité', value: 'SPIRITUALITE' },
  { label: '🏛️ Histoire islamique', value: 'HISTOIRE_ISLAMIQUE' },
  { label: '🔤 Langue arabe', value: 'LANGUE_ARABE' },
  { label: '🧒 Éducation enfants', value: 'EDUCATION_ENFANTS' },
  { label: '👤 Biographie savants', value: 'BIOGRAPHIE_SAVANTS' },
...
const LANGUAGES = [
  ...
  { label: '🇸🇦🇫🇷 Bilingue', value: 'ARABE_FRANCAIS' },
